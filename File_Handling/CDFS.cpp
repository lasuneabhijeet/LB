...
void man(char*name)
{
    ...
    if(strcmp(name,"create") == 0)
    {
        ...
        printf("usage : create filr_name permission\n");
    }
    else if(strcmp(name,"read") == 0)
    {
        printf("Description : used to read data from regular file\n");
        printf("usage : read file name no_of_bytes_to_read\n");
    }
    ...
    {
        printf("Description : used to dremove data from file\n");
    ...
    else if(strcmp(name,"lseek") == 0)
    {
        ...
        printf("usage : lseek FIle_name chageInOffset StarPoint\n");
    }
...
int main()
{
    ...
    while(1)
    {
        ...
        else if(count == 3)
        {
            ...
            { printf("ERROR : Incorrect parameters \n");}
            if(ret == -2)
            { printf("ERROR : There is no innode\n");}
            if(ret == -3)
